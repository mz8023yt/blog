...
客退手机拿到手上，确认到的现象是，无法正常开机进入系统，卡死在 android logo 界面。

### 背景知识

android 手机开机一般都有三帧 boot logo，第一帧是 "Power by android"，第二帧一般是各个手机品牌商的品牌 logo，第三帧就是定制的开机动画了。  
此问题是没有跳转到第二帧，卡死在第一帧，所有关键看第一帧和第二帧切换期间哪里出了问题。
...
(8) 回读不良机的 system 镜像，使用 ext2explore.exe 解压确认，发现不良原因确实是 /system/vendor/bin/boot_logo_updater 损坏，导致不能打开 boot_logo_updater。
...
【第二张 logo 初始化显示位置】：
Z:\work\E260L_CMCC_0919_eng\device\mediatek\mt6755\init.mt6755.rc
